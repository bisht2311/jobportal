  ...
  return (
    <div className='text-center'>
        <div className='flex flex-col gap-5 my-10'>
            ...
            <div className='flex w-[35%] shadow-md border border-gray-200 pl-3 rounded-full items-center gap-4 mx-auto h-10'>
                <input type='text'
                placeholder='Find your dream jobs'
                className='outline-none border-none w-full'
                onChange={(e)=>SetQuery(e.target.value)}
                />
                <Button onClick={searchJobHandler} className="rounded-r-full bg-[#6A38C2] hover:hover:bg-[#753fd3]">
